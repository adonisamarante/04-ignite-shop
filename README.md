...
- [Stitches CSS-in-JS](https://stitches.dev/) = npm install @stitches/react
...
- Shopping cart lib = npm i use-shopping-cart

- Icons with Phosphor = npm i @phosphor-icons/react
